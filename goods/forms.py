...
class GoodsForm(forms.Form):
    name = forms.CharField(required=True, max_length=20, error_messages={'required': '商品名称必填', 'max_length': '商品名称不能超过20字符'})
    goods_sn = forms.CharField(required=True, max_length=20, error_messages={'required': '商品数量必填'})
    category = forms.CharField(required=True, max_length=20, error_messages={'required': '商品分类必填'})
    goods_nums = forms.CharField(required=True, error_messages={'required': '商品数量必填'})
